...
Even worse, they are *very slow* because every polyfill is written in JavaScript.
...
![Loading image in WebView](https://cdn-images-1.medium.com/max/1600/1*Ydz6PTEAC5Ji20A-pJDkZQ.jpeg)
...
![rn.gif](https://cdn-images-1.medium.com/max/1600/1*qrEdHE6lF5NJ8qAx4ZLlQA.gif)
